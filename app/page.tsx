        ...
        <section className="relative overflow-hidden pt-20 pb-24 lg:pt-28 lg:pb-32">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-8">
            ...
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed">
              ...
              and ImageKit CDN. Store, organize, preview, and batch-download
              your assets with lightning speed. Featuring nested folders, secure
              JWT rotation, and ImageKit CDN.
            </p>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div className="text-center space-y-3 max-w-xl mx-auto">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                ...
                devices. Every feature you need to organize your files
